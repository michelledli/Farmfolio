...
class FrontController {
    ...
    public static void getSearchKeyEntityId(Context ctx){
    ...
    public static void postSearchKeyEntityId(Context ctx){
    ...
    public static void putSearchKeyEntityId(Context ctx){
    ...
    public static void patchSearchKeyEntityId (Context ctx){
    ...
    public static void deleteSearchKeyEntityId (Context ctx){
